...
require_once 'includes/modals/modal-kardex.php';

$idProfesor = $_SESSION['profesor_id'];

$sql = "SELECT * FROM kardex as b INNER JOIN alumno_profesor as ap ON b.ap_id = ap.ap_id INNER JOIN profesor_materia as pm ON 
 ...
 <main class="app-content">
      <div class="app-title">
        <div>
          ...
          <button class="btn btn-danger " title="Eliminar" onclick="openModalKardex()">Registrar</button>
        </div>
                  ...
                  <?php if ($row > 0) {
                    ...
                    ?> 
                        ...
                        <td><?= $ap_id = $data['ap_id']?></td>
                           ...
                           <td><?= $data['fecha']?></td>
                           <td> <button class="btn btn-danger " title="Eliminar" onclick="insertarKardex(<?= $data['kardex_id']?>)">Editar</button></td>
                        </tr>
