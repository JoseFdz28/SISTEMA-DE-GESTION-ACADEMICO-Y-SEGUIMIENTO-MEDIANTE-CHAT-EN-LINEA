...
$sqla= "SELECT * FROM ev_entregadas as ev INNER JOIN alumnos as a ON ev.alumno_id = a.alumno_id INNER JOIN 
evaluaciones as eva ON ev.evaluacion_id = eva.evaluacion_id INNER JOIN contenidos as c ON eva.contenido_id = 
c.contenido_id WHERE ev.evaluacion_id =?";
 ...
 <main class="app-content">
      ...
      <div class="tile">
            ...
            <div class="tile-body">
                ...
                <b>Valor: <kbd><?= $data['porcentaje']; ?></kbd></b>   
            </div>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <tr>
                    ...
                    <a class="btn btn-primary" href="BASE_URL<?= $data2['material_alumno'];?> "target="_black">Material</a>
                </div>
