...
$sqlc = "SELECT * FROM alumno_profesor as ap INNER JOIN profesor_materia as pm ON ap.pm_id = pm.pm_id 
INNER JOIN alumnos as al ON ap.alumno_id = al.alumno_id WHERE pm.profesor_id = $idProfesor AND pm.pm_id = $curso 
            ...
            <table class="table table-hover table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="list-notas.php?alumno=<?= $data['alumno_id'] ?>&curso=<?= $data
                        ['pm_id'] ?>">
