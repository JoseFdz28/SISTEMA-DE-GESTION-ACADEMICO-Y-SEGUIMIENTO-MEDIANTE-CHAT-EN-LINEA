 ...
 <main class="app-content">
     ...
     <button class="btn btn-success" type="button" onclick="openModalEvaluacion()">Nuevo Evaluacion</button>
      ...
      <div class="tile">
            ...
            <i class="fa fa-edit"></i>Editar Evaluacion</button> <button class="btn btn-danger icon-btn" 
            onclick="eliminarEvaluacion(<?= $data['evaluacion_id']; ?>)">
            <i class="fa fa-delet"></i>Eliminar Evaluacion</button> <a class="btn btn-warning icon-btn"
             href="entregas.php?curso=<?= $curso; ?>&contenido=<?= $data['contenido_id']; ?>&eva=<?= $data['evaluacion_id']; ?>">
             <i class="fa fa-edit"></i>Ver Entregas </a></p>
            </div>
            <div class="tile-body">
