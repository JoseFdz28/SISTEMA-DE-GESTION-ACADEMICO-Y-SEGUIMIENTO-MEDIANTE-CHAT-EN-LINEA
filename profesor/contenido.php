 ...
 <main class="app-content">
     ...
     <button class="btn btn-success" type="button" onclick="openModalContenido()">Nuevo Contenido</button>
        ...
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="#">Contennidos a evaluar</a></li>
        </ul>
      </div>
      <div class="row">
        <?php if ($row > 0) {
      ...
      <div class="tile">
            <div class="title-title-w-btn">
                ...
                <p><button class="btn btn-info icon-btn" onclick="editarContenido(<?= $data['contenido_id']; ?>)">
            <i class="fa fa-edit"></i>Editar Contenido</button> <button class="btn btn-danger icon-btn" 
            onclick="eliminarContenido(<?= $data['contenido_id']; ?>)">
            <i class="fa fa-delet"></i>Eliminar Contenido</button> 
